...
### Requirement: The page shows what the family is sourced from

The page SHALL show the citations the family's record makes: each naming the source
...
A family's record citing nothing SHALL be shown without this section, rather than
with an empty one.
